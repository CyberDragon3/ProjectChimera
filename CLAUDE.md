...
Project Chimera — a biologically-inspired OS homeostasis daemon for Windows 11. Three tiers of reflex arcs (Worm/Fly <10 ms, Zebrafish/Mouse 1–30 s, Jarvis LLM 2–5 s) maintain system stability through non-destructive process-priority steering. Design doc: `C:\Users\terry\.claude\plans\i-have-a-new-glowing-aho.md`.
